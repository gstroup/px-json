...
function runBaseTests() {
  px_json_1 = document.getElementById('px_json_1');

  suite('Base Automation Tests for px-json', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-json fixture is created', function() {
      assert.isTrue(document.getElementById('px_json_1') !== null);
    });
